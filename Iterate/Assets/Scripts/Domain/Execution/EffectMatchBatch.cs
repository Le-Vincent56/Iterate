...
namespace Iterate.Domain.Execution
{
    ...
    /// the occurrence and whose qualifiers pass — the creators (qualified added-execution effects
    /// awaiting commitment), and the target-lock updates (qualified lock-tracking effects awaiting a
    /// commit that writes no register). Captured complete before the first sibling resolves; mid-batch
    ...
    /// <param name="TargetLockUpdates">The qualified target-lock updates in resolution order; non-null.</param>
