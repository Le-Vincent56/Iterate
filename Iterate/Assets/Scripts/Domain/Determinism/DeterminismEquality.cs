...
{
    /// <summary>
    /// Structural-equality helper for the decision-record contract. The record types carry read-only lists
    /// whose default reference equality would make two independently-built-but-equal records unequal; this
    /// element-wise comparison lets replay-by-recomputation assert full record equality across a fresh
    /// decision.
    /// </summary>
    internal static class DeterminismEquality
    {
        /// <summary>
