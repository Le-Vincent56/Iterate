...
{
    /// <summary>
    /// Validates the Directives file: the common definition fields and the required effects.
    /// </summary>
    public sealed class DirectiveRuleSet : ICategoryRuleSet
    {
        ...
        /// </summary>
        public CatalogFileKind Kind => CatalogFileKind.Directive;

        /// <summary>
        /// The manifest category token this rule set answers to.
        /// </summary>
        public string CategoryToken => "DIRECTIVE";

        /// <summary>
        /// Validates the Directives file's parsed value tree.
        /// </summary>
        ...
        public void ValidateFile(JsonValue fileRoot, CatalogValidationContext context)
        {
            ...
            {
                context.AddError("$", "definition.file-not-array", "a Directives file must be an array.");
                return;
            }
            ...
            for (int index = 0; index < array.Items.Count; index++)
            {
                ...
                context.ValidateCommonFields(definition, path, CategoryToken, "DIR", _allowedKeys);
