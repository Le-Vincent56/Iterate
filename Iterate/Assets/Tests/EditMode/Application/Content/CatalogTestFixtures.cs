...
namespace Iterate.Application.Content.Tests
{
    ...
    public static class CatalogTestFixtures
    {
        ...
        public const string ValidParametersFile = @"[
            ...
            { ""id"": ""WB-PAR-037"", ""name"": ""Delete Repository item price"", ""value"": 3, ""unit"": ""tokens"", ""scope"": ""GLOBAL"" },
            { ""id"": ""WB-PAR-038"", ""name"": ""Duplicate Repository item price"", ""value"": 7, ""unit"": ""tokens"", ""scope"": ""GLOBAL"" },
            { ""id"": ""WB-PAR-039"", ""name"": ""Patch replacement fee"", ""value"": 3, ""unit"": ""tokens"", ""scope"": ""GLOBAL"" }
        ]";
